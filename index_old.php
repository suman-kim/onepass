...
<main class="main">
    ...
    <div class="content">
        <div class="py-4 px-3 px-md-4">
            ...
            <div class="row">
                <div class="col-md-6 col-xl-5 mb-3 mb-md-4">
                    <!-- Card -->
                    <div class="card h-100">
                        <div class="card-header d-flex">
                            <h5 class="h6 font-weight-semi-bold text-uppercase mb-0">공지사항</h5>
                        </div>
                ...
                <div class="col-md-6 col-xl-7 mb-3 mb-md-4">
                    <!-- Card -->
                    <div class="card h-100">
                        <div class="card-header d-flex">
            ...
            <div class="col-md-6 col-xl-5 mb-3 mb-md-4" style="float: right; width: 25%; height: 96.2%;">
                <div class="card h-100">
                    <div class="card-header p-0 ">
                        <ul id="wallets" class="nav nav-v2 nav-primary nav-justified d-block d-xl-flex w-100" role="tablist">
                            <li class="nav-item border-bottom">
                                <a class="nav-link  d-flex align-items-center p-xl-4 font-weight-semi-bold text-uppercase mb-0 active " style="padding: 1.5rem 1rem;" href="#live" role="tab" aria-selected="true" data-toggle="tab" >
                                    <span>실시간 알림</span>
                                </a>
                            </li>
                            <li class="nav-item border-bottom border-xl-left">
                                <a class="nav-link  d-flex align-items-center p-xl-4 font-weight-semi-bold text-uppercase mb-0" style="padding: 1.5rem 1rem;" href="#call" role="tab" aria-selected="false" data-toggle="tab">
                                    <span>통화관리</span>
                                </a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-pane fade show active" id="live" role="tabpanel">
                            <div class="row text-center">
                                <div class="col-6 col-md-8 mb-3 mb-md-0">
                                    <img class="avatar rounded-circle" src="documentation/img/avatar-2.jpg" alt="Image Description" style="margin-top: 10px;">
                                    <div class="h3 mb-0" style="float: right; width: 70%;">
                                        <span>$12,012</span><br>
                                        <small class="text-muted">실시간 알림</small>
                                    </div>
                                </div>
                                <div class="col-md-4 p-xl-3">
