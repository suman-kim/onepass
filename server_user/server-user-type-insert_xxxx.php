			...
			<div class="container-fluid pb-5">
				...
				<div class="row justify-content-md-center">
					<div class="card-wrapper col-12 col-md-10 mt-3">
						...
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">서버 사용자 유형 추가</h4>
								<form name = "type_insert_form" method = "POST">
									<div class="form-group">
										<label for="type_name">서버 사용자 유형 이름</label>
										<input type="text" class="form-control" id="type_name" name="type_name">
									</div>
									<button type="button" onclick="javascript: go_server_user_type_insert();" class="btn btn-primary btn-block">생 성</button>
								</form>
							</div>
						</div>
					</div>
