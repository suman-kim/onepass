			...
			<div class="container-fluid pb-5">
				...
				<div class="row justify-content-md-center">
					<div class="card-wrapper col-12 col-md-10 mt-3">
						...
						<div class="card">
							<div class="card-body">
								<h4 class="card-title"></h4>사용자 직군 추가</h4>
								<form name = "job_groups_insert_form" method = "POST">
									<div class="form-group">
										<label for="job_groups_name">사용자 직군 이름</label>
										<input type="text" class="form-control" id="job_groups_name" name="job_groups_name">
									</div>
									<button type="button" onclick="javascript: go_user_job_group_insert();" class="btn btn-primary btn-block">생 성</button>
								</form>
							</div>
						</div>
					</div>
