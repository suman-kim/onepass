			...
			<div class="container-fluid pb-5">
				...
				<div class="row justify-content-md-center">
					<div class="card-wrapper col-12 col-md-10 mt-3">
						...
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">사용자 그룹 수정</h4>
								<form name = "group_update_form" method = "POST">
									...
									<button type="button" onclick="javascript: go_user_group_update();" class="btn btn-primary btn-block">수 정</button>
								</form>
							</div>
						</div>
					</div>
