					...
					<div class="card-wrapper col-12 col-md-10 mt-3">
						...
						<div class="card">
							<div class="card-body">
								...
								<form name = "job_positions_insert_form" method = "POST">
									...
									<button type="button" onclick="javascript: go_user_job_position_insert();" class="btn btn-primary btn-block">생 성</button>
								</form>
							</div>
						</div>
					</div>
